...
class KegiatanActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val kegiatanList = listOf(
            ...
            Kegiatan(R.drawable.img_3, "Foto bersama Kepala Desa Sebelum Malam 17 Agustus", "Selasa, 16 Agustus 2024", "Menjelang malam 17 Agustus, kami bersama Kepala Desa bersiap menyambut kemeriahan perayaan kemerdekaan. Semangat kebersamaan ini menjadi kekuatan dalam memperingati hari bersejarah bagi bangsa"),
